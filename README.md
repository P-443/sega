...
- 👑 **قاعدة حجر الخواجة**: الحجر اللي لسه ماتحركش من مكانه الأصلي (`moved = false`) عليه شارة «خ»، وأي خط **أفقي أو رأسي أو قطري** فيه حجر خواجة **مش بيتحسب فوز** — القاعدة محكومة من Game Rules Engine مستقل وقابلة للضبط.
...
- **قاعدة الخواجة**: أي خط (أفقي / رأسي / **قطري**) فيه حجر `moved = false` ⇒ **ليس فوزًا**، ويظهر تنبيه للاعب مع تمييز الطوبة.
